...
ArrayList al1 = query.viewVehicleBook(vname,status,type,fdate,tdate);
ArrayList all=VehicleCommon.getVehicles();
int size = al1.size();
  ...
  function PrintReport() {
    ...
    <tr>
      ...
      <select name="vname"  id="vname">
		...
		%>
		<option value="<%=(String)all.get(j)%>">&nbsp;<%=(String)all.get(j)%></option>
		<% } %>
        </select>
      </label></td>
      <td>&nbsp;</td>
