...
<script src="include/epoly.js" type="text/javascript"></script>
 
<%
String StLoc = (String)session.getAttribute("StLoc");
String DestLoc = (String)session.getAttribute("DesLoc");
...
<div id="logo"><a href="#/index.html"></a></div>
      ...
      <tbody><tr> 
        <td id="leftside" valign="top"> <div id="map" style="width: 600px; height: 400px; border:#990000 solid 2px;"></div>
          ...
          <br>
<div id="controls">
 <form  id="trackMove" name="trackMove" onSubmit="start();return false" action="MM_getDest()">
  <table width="539" border="0" align="center">
    ...
    <tr>
      ...
      <td width="286"><label>
        <input size="40" maxlength="30" id="startpoint" type="text" value=<%= StLoc %> />
      </label></td>
    </tr>
    <tr>
      ...
      <td><label>
              <input size="40" maxlength="30" id="endpoint" type="text" value=<%= DestLoc %> />
      </label></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      <td colspan="3" bgcolor="#D29C1A">&nbsp;</td>
          ...
          <div class="textbox">&nbsp;Start <%= StLoc %></div>
              <div class="textbox">&nbsp;End <%= DestLoc %></div>
<div class="miles">
<font color="#FF0000"><center>
 ...
 <script type="text/javascript">
    ...
    if (GBrowserIsCompatible()) {
      ...
      map.setCenter(new GLatLng(6.8649, 79.8997), 12);
