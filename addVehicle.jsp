...
<form id="form1" name="form1" method="post" action="do?MOD=MTN&ACT=AddVehicle" enctype="multipart/form-data">
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <td>:</td>
      <td><label>
        <input name="NoofSeat" type="number" id="NoofSeat" size="10" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Average Load Carrying</td>
      <td>:</td>
      <td><label>
        <input name="Payload" type="number" id="Payload" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td>:</td>
      <td><label>
        <input name="Cost" type="number" id="Cost" size="10" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><label>
        <select name="vtype">
		<option value="Rent Cars">&nbsp;Rent Cars</option>
    ...
    <tr>
      ...
      <td>:</td>
      <td><label>
        <input name="InsuranceID" type="text" id="InsuranceID" />
      </label></td>
      <td>&nbsp;</td>
    </tr>    
    ...
    <tr>
      ...
      <td>:</td>
      <td><label>
        <input name="insval" type="number" id="insval" size="10" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
        <input name="Submit" type="submit" class="redButton" onclick="MM_validateForm('VehicleName','','R','VehicleNo','','R','Make','','R','Rs','','R','Cost','','R','InsurerName','','R','CompanyName','','R');return document.MM_returnValue" value="Add Vehicle" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
  </table>
