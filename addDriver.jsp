...
<form id="form1" name="form1" method="post" action="do?MOD=MTN&ACT=AddDRV" >
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
        <input name="Submit" type="submit" class="redButton" onclick="MM_validateForm('FirstName','','R','LastName','','R','AddLine1','','R','City','','R','MobileNo','','RisNaN','LicenseNo','','R');return document.MM_returnValue" value="Add Driver" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
  </table>
